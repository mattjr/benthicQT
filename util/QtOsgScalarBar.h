#ifndef QTOSGSCALARBAR_H
#define QTOSGSCALARBAR_H
...
*/
class QtOsgScalarBar: public osg::Geode
{
...
public:
    ...
    */
    ...
    /** Default constructor. */
    QtOsgScalarBar(osgText::Font *font): osg::Geode(),
        _numColors(256),
        _numLabels(11),
    ...
    */
    QtOsgScalarBar(osgText::Font *font,int numColors, int numLabels, osgSim::ScalarsToColors* stc,
    ...
    /** Copy constructor */
    QtOsgScalarBar(const QtOsgScalarBar& rhs, const osg::CopyOp& co): osg::Geode(rhs,co),
    ...
    void setOrientation(QtOsgScalarBar::Orientation orientation);

    /** Get the orientation of the ScalarBar.  @see Orientation */
    QtOsgScalarBar::Orientation getOrientation() const;
